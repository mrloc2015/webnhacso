                  ...
                  <div class="mid-col">
                        <div id="idMainContent" class="main-content" align="center">                   
                            <!-- InstanceBeginEditable name="mainConten" -->
                            	 <div class="cp-title">
								Quản lý Playlist
                                <div class="remove-cp" onclick="MoRongDieuKhien(this,'cpPlaylist')"></div>
                            </div>
                            <div id="cpPlaylist" class="main-content">
                           		
                                    <form action="xulyTimKiem.php" method="post" id="frmTimUser" onsubmit="Post(this,'idPlayList');return false">
                                        <label for="txtKeyWord">Tìm Playlist:</label>
                                        <input type="text" alt="Nhập tên playlist" name="txtPlaylist">
                                        <input type="submit" value="Tìm" name="btnPlaylist">
                                	</form>
                                    <br>
                                    <div align="left"> Danh Sách Playlist</div>
                                    <div class="user-list" id="idPlayList">
